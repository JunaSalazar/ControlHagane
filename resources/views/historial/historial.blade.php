...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          <?php
            ...
            ->select('cliente.*','contacta.id as c_id', 'contacta.hora as hora', 'contacta.fecha as fecha', 'contacta.comentario as comentario')
          ...
          <tr>
            ...
            // **************************************************************************************************************
                ...
                <td>
                  ...
                  <form action="{{URL('historial/'. isset($historial) ?: '')}}" method="POST">
                  <a href="{{URL('historial/'. $c->c_id.'/edit')}}" class="btn btn-success gradient glyphicon glyphicon-eye-edit"><span class="glyphicon glyphicon-edit"></span></a>
                  </form>
                </td>
            </tr>
            @endforeach
